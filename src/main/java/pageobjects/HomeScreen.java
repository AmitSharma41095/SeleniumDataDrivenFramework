...
import property.ObjectRepository;
import testsuitebase.Suitebase;
import utility.SeleniumUtils;
//all methods inside SeleniumUtils are markes as static... access those methods with classname .. ex SeleniumUtils.click(locator, "string")
public class HomeScreen implements ObjectRepository{
